...
# Basic financials
print(finnhub_client.company_basic_financials(TICKER, "all"))
...
print(finnhub_client.company_profile(symbol=TICKER))
print(finnhub_client.newsroom(TICKER))

print(finnhub_client.stock_presentation(TICKER))
print(finnhub_client.stock_revenue_breakdown2(TICKER))



print(finnhub_client.earnings_call_live('2024-11-01', '2024-11-24', 'NVDA'))
print(finnhub_client.historical_employee_count(TICKER, '2020-01-01', '2024-01-01'))
print(finnhub_client.airline_price_index('united', '2022-01-01', '2025-01-01'))

print(finnhub_client.historical_market_cap(TICKER, '2022-01-01', '2024-01-01'))
print(finnhub_client.company_historical_esg_score(TICKER))
...
print(finnhub_client.congressional_trading(TICKER, '2024-01-01', '2024-03-31'))
print(finnhub_client.price_metrics(symbol="AAPL", date="2022-01-01"))

# Filings
print(finnhub_client.filings(symbol="AAPL", _from="2024-01-01", to="2024-01-15"))
...
print(finnhub_client.sec_similarity_index(TICKER))

# Bid Ask
print(finnhub_client.last_bid_ask(TICKER))
...
# Revenue breakdown
print(finnhub_client.stock_revenue_breakdown(TICKER))
...
# Supply chain
print(finnhub_client.stock_supply_chain(TICKER))

# Company ESG
print(finnhub_client.company_esg_score("AAPL"))

# Earnings Quality Score
print(finnhub_client.company_earnings_quality_score(TICKER, 'quarterly'))
